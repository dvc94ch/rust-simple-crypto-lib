...
mod tests {
    ...
    fn test_to_base64() {
        ...
        let expected =
            ...
            IHNpbmd1bGFyIHBhc3Npb24gZnJvbSBvdGhlciBhbmltYWxzLCB3aGljaCBpcyBhIGx1c3Qgb2Ygd\
            GhlIG1pbmQsIHRoYXQgYnkgYSBwZXJzZXZlcmFuY2Ugb2YgZGVsaWdodCBpbiB0aGUgY29udGludW\
            VkIGFuZCBpbmRlZmF0aWdhYmxlIGdlbmVyYXRpb24gb2Yga25vd2xlZGdlLCBleGNlZWRzIHRoZSB\
            zaG9ydCB2ZWhlbWVuY2Ugb2YgYW55IGNhcm5hbCBwbGVhc3VyZS4";
        assert_eq!(to_base64(&utils::from_ascii(&String::from(ascii))), expected);
    }
    ...
    fn test_from_base64() {
        ...
        let expected =
            ...
            the continued and indefatigable generation of knowledge, exceeds the short \
            vehemence of any carnal pleasure.";
        assert_eq!(utils::to_ascii(&from_base64(&String::from(base64))), expected);
    }
